...
@Component({
  selector: 'app-userbookingsvehicle',
  templateUrl: './userbookingsvehicle.component.html',
  styleUrls: ['./userbookingsvehicle.component.scss','../../../common/commonstyle.scss']
})
export class UserbookingsvehicleComponent implements OnInit {
